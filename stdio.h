...
#ifdef CVI_UTF8
#define remove removeUtf8
#define rename renameUtf8
#define tmpnam tmpnamUtf8
#define fopen fopenUtf8
#define freopen freopenUtf8
#else
#ifdef CVI_INSTRSUP_COMPAT
#define removeAnsi remove
#define renameAnsi rename
#define tmpnamAnsi tmpnam
#define fopenAnsi fopen
#define freopenAnsi freopen
#else
#define remove removeAnsi
#define rename renameAnsi
#define tmpnam tmpnamAnsi
#define fopen fopenAnsi
#define freopen freopenAnsi
#endif
#endif
	
int CVIANSI removeAnsi(const char *);
int CVIANSI removeUtf8(const char *);
int  CVIANSI renameAnsi(const char *, const char *);
int  CVIANSI renameUtf8(const char *, const char *);
FILE * CVIANSI tmpfile(void);
char * CVIANSI tmpnamAnsi(char *);
char * CVIANSI tmpnamUtf8(char *);
int  CVIANSI fclose(FILE *);
int  CVIANSI fflush(FILE *);
FILE * CVIANSI fdopen(int, const char *);
FILE * CVIANSI fopenAnsi(const char *, const char *);
FILE * CVIANSI fopenUtf8(const char *, const char *);
FILE * CVIANSI freopenAnsi(const char *, const char *, FILE *);
FILE * CVIANSI freopenUtf8(const char *, const char *, FILE *);
