...
#define  ADC_TAB_ADC_NUM_SCAN_INTERVAL    11      /* control type: numeric, callback function: (none) */
#define  ADC_TAB_NUM_TRIG_LEVEL           12      /* control type: numeric, callback function: (none) */
#define  ADC_TAB_ADC_NUM_SAMP_PER_TRIG    13      /* control type: numeric, callback function: (none) */
#define  ADC_TAB_ADC_BTN_RELEASE          14      /* control type: command, callback function: AdcReleaseCB */
#define  ADC_TAB_ADC_BTN_STOP_ACQ         15      /* control type: command, callback function: AdcStopCB */
#define  ADC_TAB_ADC_BTN_SINGLE           16      /* control type: command, callback function: AdcSingleShotCB */
#define  ADC_TAB_ADC_BTN_START_ACQ        17      /* control type: command, callback function: AdcStartCB */
#define  ADC_TAB_ADC_BTN_SAVE             18      /* control type: command, callback function: AdcSaveCB */
#define  ADC_TAB_ADC_BTN_CONFIGURE        19      /* control type: command, callback function: AdcConfigureCB */
#define  ADC_TAB_ADC_BTN_REGISTER         20      /* control type: command, callback function: AdcRegisterCB */
#define  ADC_TAB_ADC_GRAPH_TIME           21      /* control type: graph, callback function: (none) */
#define  ADC_TAB_ADC_GRAPH_FFT            22      /* control type: graph, callback function: (none) */
#define  ADC_TAB_ADC_MSG_STATUS           23      /* control type: textMsg, callback function: (none) */
#define  ADC_TAB_ADC_BTN_RECORD           24      /* control type: command, callback function: AdcRecordCB */
#define  ADC_TAB_ADC_TIMER_POLL           25      /* control type: timer, callback function: AdcPollTimerCB */
...
#define  DDS_TAB_DDS_NUM_ADC_SAMP_RATE    22      /* control type: numeric, callback function: (none) */
#define  DDS_TAB_DDS_NUM_ADC_CLK          23      /* control type: numeric, callback function: (none) */
#define  DDS_TAB_DDS_NUM_CALC_PERIOD      24      /* control type: numeric, callback function: (none) */
#define  DDS_TAB_DDS_NUM_CHIRP_STEPS      25      /* control type: numeric, callback function: (none) */
#define  DDS_TAB_DDS_NUM_SYNC_CLK         26      /* control type: numeric, callback function: (none) */
#define  DDS_TAB_DDS_NUM_TX_BW            27      /* control type: numeric, callback function: (none) */
#define  DDS_TAB_DDS_NUM_TX_CENTRE        28      /* control type: numeric, callback function: (none) */
#define  DDS_TAB_DDS_NUM_ACT_START        29      /* control type: numeric, callback function: (none) */
#define  DDS_TAB_DDS_RING_CHIRP_MODE      30      /* control type: ring, callback function: (none) */
#define  DDS_TAB_DDS_MSG_STATUS           31      /* control type: textMsg, callback function: (none) */
#define  DDS_TAB_DDS_TIMING_TEXT          32      /* control type: textMsg, callback function: (none) */
#define  DDS_TAB_DDS_MSG_TIMING_WARN      33      /* control type: textMsg, callback function: (none) */
#define  DDS_TAB_DDS_RING_RESOURCE        34      /* control type: ring, callback function: (none) */
#define  DDS_TAB_DDS_NUM_SCAN_INTERVAL    35      /* control type: numeric, callback function: (none) */
#define  DDS_TAB_DDS_NUM_FIXED_DIV2       36      /* control type: numeric, callback function: (none) */
